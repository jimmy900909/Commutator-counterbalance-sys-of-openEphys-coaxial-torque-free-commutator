...
const float HX_RATE_HZ = 80.0f;   // sampling rate after soldering modication
...
const int   MAX_PAYOUT_PWM    = 110; //upperlimit of payout
...
// ---------------- Smoothen tension for EMA filter----------------
float T_fast_g = 0.0f;                
float T_slow_g = 0.0f;                
...
// Active-Coast when the tension near the upper limit
...
void setup() {
  ...
  Serial.println("Ready ver5.instant-payout (no SD log).");
}
